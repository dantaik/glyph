...
/**
 * A post as the bundle carries it: the row, plus the document itself. A v2
 * post also says which contract holds it and which hook it went through,
 * so a bundle read decades from now still knows where the post lives.
 */
